...
// API credentials and URLs - loaded from environment variables (never hardcode secrets)
export const AMADEUS_API_KEY = import.meta.env.VITE_AMADEUS_API_KEY;
export const AMADEUS_API_SECRET = import.meta.env.VITE_AMADEUS_API_SECRET;
export const API_URL = import.meta.env.VITE_API_URL || 'https://www.jetsetterss.com/api';
