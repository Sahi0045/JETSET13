...
const DocumentServices = () => {
  ...
  const services = [
    {
      ...
      description:
        "Renew your expiring passport with expert assistance. We handle all paperwork and embassy submissions.",
      fee: "$89",
    ...
    },
    {
      ...
      description:
        "Comprehensive travel insurance covering medical emergencies, trip cancellations, and lost baggage.",
      fee: "$45",
    ...
    },
    {
      ...
      description:
        "Official attestation and apostille services for legal documents required for international use.",
      fee: "$65",
    ...
    },
    {
      ...
      description:
        "Certified translation of official documents by accredited translators for visa and legal purposes.",
      fee: "$35",
    ...
    },
    {
      ...
      description:
        "Compliant passport and visa photos meeting all embassy specifications, delivered digitally.",
      fee: "$15",
    ...
    },
    {
      ...
      description:
        "Official travel itinerary letter for visa applications, showing your planned travel dates and routes.",
      fee: "$25",
  ...
  const validate = () => {
    const errors = {};
    if (!selectedService)
      errors.selectedService = "Please select a service type.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Build notes with all service details
      const notesLines = [
        `Service: ${selectedServiceData?.title || selectedService}`,
        `Urgency: ${urgencyData?.label || urgency} (${urgencyData?.time || ""})`,
        formData.phone ? `Phone: ${formData.phone}` : null,
        formData.passportExpiry
          ? `Passport Expiry: ${formData.passportExpiry}`
          : null,
        formData.travelDateFrom
          ? `Travel From: ${formData.travelDateFrom}`
          : null,
        formData.travelDateTo ? `Travel To: ${formData.travelDateTo}` : null,
      ...
      const payload = {
        ...
        amount: parseFloat(
          (selectedServiceData?.fee || "$0").replace(/[^0-9.]/g, "") || "0",
        ),
        notes: notesLines,
      };
      ...
      setSubmitSuccess({
        ...
        urgency: urgencyData?.label,
        processingTime: urgencyData?.time,
        id: data.data?.id,
      });
    } catch (err) {
      console.error("DocumentServices submit error:", err);
      setSubmitError(
          ...
          <div className="bg-white rounded-3xl shadow-2xl shadow-slate-200/40 p-10 max-w-lg w-full text-center">
            ...
            <p className="text-slate-500 mb-8">
              ...
              <span className="font-bold text-slate-700">
                {submitSuccess.service}
              </span>{" "}
              request has been received. A confirmation and next steps have been
              sent to{" "}
              <span className="font-bold text-slate-700">
                {submitSuccess.email}
              </span>
              ...
              {[
                {
                  icon: "category",
                  label: "Service",
                  value: submitSuccess.service,
                },
                {
                  icon: "speed",
                  label: "Processing",
                  value: `${submitSuccess.urgency} — ${submitSuccess.processingTime}`,
                },
                {
                  icon: "mail",
                  label: "Confirmation",
                  value: `Sent to ${submitSuccess.email}`,
                },
                {
                  icon: "support_agent",
                  label: "Next Step",
                  value: "Our team will contact you within 1 business day",
                },
              ].map((item, i) => (
                <div
                  key={i}
        ...
        <div className="flex flex-col w-full max-w-[1200px] flex-1">
          ...
          <div className="mb-10">
            ...
            <p className="text-slate-600 text-lg max-w-2xl">
              Professional document services for all your international travel
              needs. Select a service below to get started.
            </p>
          </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between gap-2 mb-1">
                            ...
                            <span className="text-[#1152d4] font-black text-sm shrink-0">
                              {service.fee}
                            </span>
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {urgencyOptions.map((option) => (
                    ...
                    >
                      ...
                      <div
                        className={`text-sm font-bold ${urgency === option.id ? "text-[#1152d4]" : "text-slate-600"}`}
                      >
                        {option.price}
                      </div>
                    </button>
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full rounded-lg border ${fieldErrors.fullName ? "border-red-400 bg-red-50" : "border-slate-300"} h-11 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#1152d4]`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full rounded-lg border ${fieldErrors.email ? "border-red-400 bg-red-50" : "border-slate-300"} h-11 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#1152d4]`}
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 bg-[#1152d4] text-white rounded-lg font-bold text-base shadow-md hover:bg-[#0e42b0] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                        <svg
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6 sticky top-24">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-slate-600">
                          Processing (
                          {urgencyOptions.find((u) => u.id === urgency)?.label})
                        </span>
                        <span className="font-bold">
                          {urgencyOptions.find((u) => u.id === urgency)?.price}
                        </span>
                      </div>
                ...
                <div className="mt-6 p-4 bg-green-50 border border-green-100 rounded-lg">
                  ...
                  <p className="text-xs text-green-600">
                    All documents are handled with strict confidentiality and
              ...
              <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                ...
                <div className="space-y-2">
                  <Link
                    to="/visa/booking"
                    className="flex items-center gap-3 p-3 rounded-lg hover:bg-[#1152d4]/5 transition-colors no-underline group"
                  >
                    <span className="material-symbols-outlined text-[#1152d4] text-lg">
                      calendar_month
                    </span>
                    <div>
                      <p className="text-sm font-bold text-slate-900 group-hover:text-[#1152d4]">
                        Book Consultation
                      </p>
                      <p className="text-xs text-slate-500">
              ...
              <div className="bg-[#1152d4] rounded-xl p-6 text-white">
                ...
                <p className="text-white/80 text-sm mb-4">
                  Our visa consultants are available 24/7 to assist you.
                </p>
                <Link
                  to="/contact"
