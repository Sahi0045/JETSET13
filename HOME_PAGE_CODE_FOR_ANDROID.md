# 🏠 Jetsetterss Home Page Code - Complete Implementation Guide

This document contains the complete home page implementation from the Jetsetterss web platform. Use this code to replicate the exact same functionality and design in the Android app.

## 📱 Home Page Structure

The home page consists of multiple sections:
1. **Navbar** (Navigation Bar)
2. **Service Banner** (Self-service portal announcement)
3. **Hero Section** (Main search form with background)
4. **Destination Section** (Explore by destination grid)
5. **Cruise Line Section** (Explore by cruise line grid)
6. **Trust Indicators** (Customer stats and brand logos)
7. **Testimonials Banner** (Customer reviews with modal)
8. **Promo Section** (Special offers)
9. **Newsletter Subscription** (Email signup)
10. **Footer**
...
const HeroSection = () => {
  ...
  // ... (Complete HeroSection implementation - see full file for all code)
        ...
        <div className="hero-content">
          <div className="hero-text">
            <h1 className="hero-title">
              Discover Your Perfect <span className="highlight">Cruise Adventure</span>
            </h1>
            <p className="hero-subtitle">
              Explore breathtaking destinations with luxury cruise experiences. Find the best deals on cruises worldwide.
            </p>
          </div>

          <div className="search-container">
            <div className="search-tabs">
              <button className="tab active">Cruises</button>
            ...
            <div className="search-form">
              <div className="search-fields">
                ...
                <div className="field-group">
                  <label className="field-label">Cruise Line</label>
                  <div className="field-input">
                    <Ship className="field-icon" />
                    <select
                      value={searchValues.cruiseLine}
                      onChange={(e) => setSearchValues({...searchValues, cruiseLine: e.target.value})}
                    >
        ...
        {destinationsData.destinations.slice(0, 6).map((destination) => (
          <div key={destination.id} className="destination-card">
            ...
            <div className="destination-info">
              ...
              <p>
                Starts from <Price amount={destination.price} />/p.p
              </p>
              <Link
...
.hero-background {
  ...
  right: 0;
  bottom: 0;
  background-image: url('/images/cruise-hero-bg.jpg');
...
.hero-overlay {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(0, 102, 178, 0.8) 0%, rgba(30, 136, 229, 0.8) 100%);
}
...
### **Home Page Sections:**
1. **Navigation Bar** - Top navigation with logo and menu
2. **Service Banner** - Self-service portal announcement with contact info
3. **Hero Section** - Large background image with cruise search form
4. **Destination Grid** - 6 destination cards with ratings and prices
5. **Cruise Line Grid** - Cruise operator cards with ratings
6. **Trust Indicators** - Customer stats (12K+ customers, 150+ destinations, etc.)
7. **Testimonials** - Customer reviews with modal popup
8. **Promo Section** - Summer cruise special offer
9. **Newsletter Signup** - Email subscription with background image
10. **Scroll to Top Button** - Mobile-only floating button

### **Interactive Elements:**
- Cruise search form with destination, date, cruise line, and passenger fields
- Customer testimonial carousel with modal
...
- Static JSON data for destinations and cruise lines
- Firebase for authentication (inherited from parent)
- Responsive images and content

This complete home page implementation provides all the visual elements, functionality, and user experience from the Jetsetterss web platform. Use this code as the foundation for your Android app's home screen! 🎉
