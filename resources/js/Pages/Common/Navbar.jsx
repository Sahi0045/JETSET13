            ...
            <div className="profile-container">
              ...
              {isDropdownOpen && (
                <div className="profile-dropdown">
                  ...
                  <button onClick={() => { window.location.href = '/profile/privacy'; setIsDropdownOpen(false); }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  <button onClick={() => { window.location.href = '/profile/notifications'; setIsDropdownOpen(false); }}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="none"
